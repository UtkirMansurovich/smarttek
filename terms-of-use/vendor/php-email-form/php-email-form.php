...
class PHP_Email_Form {
  ...
  public $error_msg = array(
	...
	'invalid_from_lastname' => 'From Last Name is empty!',
    'invalid_from_email' => 'Email from: is empty or invalid!',
	'invalid_from_phone' => 'Phone from: is empty or invalid!',
  ...
  public function send() {
	...
	$from_lastname = filter_var( $this->from_lastname, FILTER_SANITIZE_STRING);
    $from_email = filter_var( $this->from_email, FILTER_VALIDATE_EMAIL);
	$from_phone = filter_var( $this->from_phone, FILTER_SANITIZE_NUMBER_INT);
    ...
    if( ! $to || md5($to) == '496c0741682ce4dc7c7f73ca4fe8dc5e') 
      $this->error .= $this->error_msg['invalid_to_phone'] . '<br>';
    ...
    //  $this->error .= $this->error_msg['invalid_from_phone'] . '<br>';
     ...
     if (strlen($from_phone) < 10 || strlen($from_phone) > 11)
     $this->error .= $this->error_msg['invalid_from_phone'] . '<br>';
