...
class PHP_Email_Form {
  ...
  public $error_msg = array('invalid_to_email' => 'Email to (receiving email address) is empty or invalid!',);

  private $error = false;
  private $attachments = [];

  public function __construct() {
    $this->mailer = "Newsletter@" . @preg_replace('/^www\./','', $_SERVER['SERVER_NAME']);
  }
  ...
  public function send() {
    ...
    try {
      ...
      // XMailer
      $mail->XMailer = 'PHP Email Form (.../php-email-form/)';
